...
class CfUserSecurity:
    ...
    def __init__(
        ...
        self.verification_expires_days: int = settings.user_security.verification_expires_days
        self.verification_expires_hours: int = settings.user_security.verification_expires_hours
