...
# Local Imports
from api.ws_workers.subworkers.base_subworker import BaseSubworker
from api.config import CONFIG
from api.db import Database
from api.db.exceptions import UserAlreadyExists, UserDoesNotExist
from api.db.types.user import User
from api.models import User as PublicUser
from api.models.validation import LoginInput, LoginInputData, RegisterInput, RegisterInputData
...
class UsersWorker(BaseSubworker):
    """
    ...
    async def login_user(
        ...
        # Validate data
        try:
            data: LoginInput = LoginInput(**data)
        except ValidationError as e:
            await self.connection.send_json(
                {
                    "action": "login",
